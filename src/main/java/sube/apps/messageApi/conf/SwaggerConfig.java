...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false).select()
				.apis(RequestHandlerSelectors.any()).paths(PathSelectors.ant("/v*/**")).build()
				.apiInfo(getMetadata());
	}

	private ApiInfo getMetadata() {
		ApiInfo apiInfo = new ApiInfo("NSSA messageApi", "Api de envío de mensajes", "1", "",
				new Contact("Nacion Servicios", "https://www.nacionservicios.com.ar", "info@nacionservicios.com.ar"), "NSSA Standard License", "https://www.nacionservicios.com.ar/license", new ArrayList<>());		return apiInfo;
	}
